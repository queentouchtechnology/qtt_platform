"""Ported from qzmaster-ai-gateway's src/ai/core/ai-provider-registry.ts —
...
from qtt_platform.ai.core.exceptions import AiProviderException, ProviderNotConfigured
from qtt_platform.ai.core.provider import AiProvider
